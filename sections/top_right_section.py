...
class Top_right_section(Window):
    ...
    def display_frame8(self):
        ...
        self.current_date_selected = Label(frame8, text=f"{selected_day}. {selected_month}, {selected_year}", font=("Verdana", 23), fg="white", bg=self.look_feel_settings["dark_blue"])
