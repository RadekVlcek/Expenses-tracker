...
class Bottom_section(Window):
    ...
    def update_total_spent(self, new_total_spent, new_remaining_balance):
        ...
        self.f5_rem_balance_value.config(text=f"€{new_remaining_balance}")

    def pass_total_spent_this_month(self, new_total_spent, remaining_balance):
        self.f5_total_spent_value.config(text=f"€{new_total_spent}")
        self.f5_rem_balance_value.config(text=f"€{remaining_balance}")